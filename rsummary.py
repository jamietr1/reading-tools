    ...
    if matchObj:
        ...
        if current_year != prev_year:
            ...
            if year_count != 0 and args.graph:
                ...
                print('{:<130} {:>4} {:>5}'.format('Year', 'Books', 'Pages'))
        ...
        if book_type == "Paper":
            if args.highlight:
                if recommended == 'Yes':
                    type_string = colored('#', 'white' , attrs=['bold'])
                else:
                    type_string = colored('#', 'white')
            else:
                type_string = "#"
            ...
            if args.highlight:
                if recommended == 'Yes':
                    type_string = colored('@', 'yellow',attrs=['bold'])
                else:
            ...
            if args.highlight:
                if recommended == 'Yes':
                    type_string = colored('+', 'cyan', attrs=['bold'])
                else:
                    type_string = colored('+', 'cyan')
            else:
                type_string = "+"
...
if year_count != 0 and args.graph:
    ...
    print('{:<130} {:>4} {:>6}'.format('Year', 'Books', 'Pages'))
year_string = current_year + " "
prev_year = current_year
print('{:<130} {:>4} {:>6}'.format('Total', total_books, total_pages))
